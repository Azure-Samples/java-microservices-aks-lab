...
1. Select **Create fork**. This will create a copy or fork of this project in your own account.
   ...
   {: .note }
   > In case you are using a GitHub EMU account, it might be you are not be able to fork a public repository. In that case, create a new repository with the same name, clone the original repository, add your new repository as a remote and push to this new remote.
